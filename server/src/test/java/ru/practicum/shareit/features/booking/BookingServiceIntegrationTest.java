...
class BookingServiceIntegrationTest {
    ...
    void shouldGetAllBookingsOfBooker() {
        List<BookingDto> bookings = bookingService.getBookingsOfBooker(booker.getId(), "ALL", 0, 10);
    ...
    void shouldGetPastAndCurrentBookingsOfBooker(LocalDateTime start, LocalDateTime end, String state) {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfBooker(booker.getId(), state, 0, 10);
    ...
    void shouldGetFutureBookingsOfBooker() {
        List<BookingDto> bookings = bookingService.getBookingsOfBooker(booker.getId(), "FUTURE", 0, 10);
    ...
    void shouldGetWaitingBookingsOfBooker() {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfBooker(booker.getId(), "WAITING", 0, 10);
    ...
    void shouldGetRejectedBookingsOfBooker() {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfBooker(booker.getId(), "REJECTED", 0, 10);
    ...
    void shouldNotGetBookingsOfBookerWithWrongState() {
        WrongStateArgumentException exception = assertThrows(WrongStateArgumentException.class,
                () -> bookingService.getBookingsOfBooker(booker.getId(), "WRONG STATE", 0, 10));
    ...
    void shouldGetAllBookingsOfOwner() {
        List<BookingDto> bookings = bookingService.getBookingsOfOwner(owner.getId(), "ALL", 0, 10);
    ...
    void shouldGetPastAndCurrentBookingsOfOwner(LocalDateTime start, LocalDateTime end, String state) {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfOwner(owner.getId(), state, 0, 10);
    ...
    void shouldGetFutureBookingsOfOwner() {
        List<BookingDto> bookings = bookingService.getBookingsOfOwner(owner.getId(), "FUTURE", 0, 10);
    ...
    void shouldGetWaitingBookingsOfOwner() {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfOwner(owner.getId(), "WAITING", 0, 10);
    ...
    void shouldGetRejectedBookingsOfOwner() {
        ...
        List<BookingDto> bookings = bookingService.getBookingsOfOwner(owner.getId(), "REJECTED", 0, 10);
    ...
    void shouldNotGetBookingsOfOwnerWithWrongState() {
        WrongStateArgumentException exception = assertThrows(WrongStateArgumentException.class,
                () -> bookingService.getBookingsOfOwner(owner.getId(), "WRONG STATE", 0, 10));
        assertEquals("Unknown state: WRONG STATE",
                exception.getMessage(), "Invalid message");
    }
